...
class Adminer extends BaseController
{
	...
	public function registrations()
	{
		...
		if ($session->logged_in == TRUE) {
			...
			$data =  [
				'registrant' => $db,
				'url' => 'https://alfurqan.com.ng/imagerender/',
			];
			echo view('adminer/header');
			echo view('adminer/sidebar');
			echo view('adminer/reg', $data);
		} else {
			$this->login();
		}
	}
	...
	public function questions()
	{
		...
		if ($session->logged_in == TRUE) {
			...
			echo view('adminer/header', $hdata);
			echo view('adminer/sidebar');
			echo view('adminer/questions', $data);
		} else {
			$this->login();
		}
	}
    ...
    public function ssquestions()
    {
        ...
        if ($session->logged_in == TRUE) {
			...
			echo view('adminer/header', $hdata);
            echo view('adminer/sidebar');
            echo view('adminer/squestions', $data);
        } else {
            $this->login();
        }
    }
	...
	public function editquestions()
	{
		...
		if ($session->logged_in == TRUE) {
			...
			echo view('adminer/header', $hdata);
			echo view('adminer/sidebar');
			echo view('adminer/questions2', $data);
		} else {
			$this->login();
		}
	}
