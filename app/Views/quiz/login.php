        ...
        <div class="mdk-header-layout__content page-content">
            <div class="bg-danger pb-lg-64pt py-3">
                <div class="container page__container">
                    <div class="d-flex flex-wrap align-items-end justify-content-between mb-16pt">
                        <img src="assets/images/logo.jpg" alt="" width="50px" class="img-fluid">
                        <h1 class="text-white flex m-0">User SignUp or Signin</h1>
                    </div>
<!-- 
                            ...
                            <li class="list-group-item my-16pt mb-lg-48pt">
                                <div class="page-section">
                                    <form action="login" method="post" class="text-center">
                                        ...
                                        <input type="email" placeholder="Enter your email" name="username" class="text-center form-control">
                                        <!-- <br> -->
